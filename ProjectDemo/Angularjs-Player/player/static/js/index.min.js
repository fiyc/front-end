...
playerApp.controller("playerCtrls", ["$scope", "DataList", "DataBinding", "Audio", "Player", "$timeout",
function($scope, DataList, DataBinding, Audio, Player) {
...
playerApp.factory("DataBinding", ["$rootScope", "DataList",
function($rootScope, DataList) {
...
playerApp.factory("Audio", ["$document",
function($document) {
    var audio = $document[0].createElement("audio");
    return audio
}]),
playerApp.factory("Player", ["$rootScope", "$interval", "Audio", "DataList", "DataBinding",
function($rootScope, $interval, Audio, DataList, DataBinding) {
...
playerApp.directive("musicMode", ["$timeout", "$document",
function($timeout, $document) {
    return {
        ...
        link: function(scope, ele) {
            ...
            function() {
                if ("list" == status) scope.player.active == scope.player.musicLen - 1 ? scope.player.active = 0 : scope.player.active += 1;
...
playerApp.directive("progressBar", ["$document", "$interval", "$rootScope",
function($document, $interval, $rootScope) {
    return {
        restrict: "AE",
        replace: !0,
        scope: {
